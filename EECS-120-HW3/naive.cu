...
main(int argc, char** argv)
{
  ...
  //cudaMalloc (&d_idata, N * sizeof (dtype));
  //cudaMalloc (&d_odata, blocks * sizeof (dtype));
  ...
  //cudaMemcpy (d_idata, h_idata, N * sizeof (dtype), cudaMemcpyHostToDevice);
  ...
  //cudaMemcpy (&h_odata, d_odata, sizeof (dtype), cudaMemcpyDeviceToHost);
